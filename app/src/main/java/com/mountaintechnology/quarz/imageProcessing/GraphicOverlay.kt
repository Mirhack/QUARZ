...
import com.mountaintechnology.quarz.imageProcessing.GraphicOverlay.Graphic
...
class GraphicOverlay(
    ...
    abstract class Graphic(private val overlay: GraphicOverlay) {
        ...
        fun getPostScaleHeightOffset(): Float {
            return overlay.postScaleHeightOffset
        }

        fun getPostScaleWidthOffset(): Float {
            return overlay.postScaleWidthOffset
        }
    ...
    fun setImageSourceInfo(
        ...
        if (imageWidth < 0) throw IOException("image width must be positive")
        if (imageHeight < 0) throw IOException("image width must be positive")
        synchronized(lock) {
